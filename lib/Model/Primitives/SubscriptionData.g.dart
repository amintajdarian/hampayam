...
JSubscriptionData _$JSubscriptionDataFromJson(Map<String, dynamic> json) {
  return JSubscriptionData(
    ...
    touched: json['touched'] == null ? null : DateTime.parse(json['touched'] as String),
    acs: json['acs'] == null ? null : JAccessLevelData.fromJson(json['acs'] as Map<String, dynamic>),
    read: json['read'] as int,
    recv: json['recv'] as int,
    clear: json['clear'] as int,
    public: json['public'] == null ? null : JPublicData.fromJson(json['public'] as Map<String, dynamic>),
    private: (json['private'] as List)?.map((e) => e as String)?.toList(),
    online: json['online'] as bool,
    topic: json['topic'] as String,
    seq: json['seq'] as int,
    seen: json['seen'] == null ? null : JSubSeen.fromJson(json['seen'] as Map<String, dynamic>),
    lastMessage: json['lastmsg'] == null ? null : LastMessage.fromJson(json['lastmsg'] as Map<String, dynamic>),
  );
}
