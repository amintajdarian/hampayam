...
JPublicData _$JPublicDataFromJson(Map<String, dynamic> json) {
  return JPublicData(
    ...
    n: json['n'] == null ? null : JName.fromJson(json['n'] as Map<String, dynamic>),
    org: json['org'] as String,
    title: json['title'] as String,
    tel: (json['tel'] as String),
    email: (json['email'] as List)?.map((e) => e == null ? null : JEmail.fromJson(e as Map<String, dynamic>))?.toList(),
    impp: (json['impp'] as List)?.map((e) => e == null ? null : JIMhandle.fromJson(e as Map<String, dynamic>))?.toList(),
    photo: json['photo'] == null ? null : JPhoto.fromJson(json['photo'] as Map<String, dynamic>),
  );
}
