...
class InfoChl extends StatelessWidget {
  bool exit = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Consumer<ChlProvider>(builder: (context, value, child) {
        return Container(
                ...
                delegate: new SliverChildListDelegate([
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            value.getDataDesc.defacs.auth.isApprove
                                ? ListTile(
                                    title: Text(
                                      'Default access mode:',
                                      style: TextStyle(fontSize: size / 55),
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: (value.getDataDesc.acs.mode
                                                .isDelete &&
                                            value
                                                .getDataDesc.acs.mode.isApprove)
                                        ? Row(
                                            children: [
                            ...
                            ...value.getDataSub.map(
                              (dataSub) => (value
                                          .getDataDesc.acs.mode.isDelete &&
                                      value.getDataDesc.acs.mode.isApprove)
                                  ? Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Visibility(
                                        visible:
                                            value.topicData.acs.mode.isShare,
                                        child: ListTile(
                                          title: Text(
                                            dataSub.public.fn,
                                            style: TextStyle(
                      ...
                      (value.getDataDesc.acs.mode.isDelete &&
                              value.getDataDesc.acs.mode.isApprove)
                          ? Container(
                              padding: EdgeInsets.all(10),
                              color: Colors.white,
