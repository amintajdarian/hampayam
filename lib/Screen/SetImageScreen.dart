...
import 'package:hampayam_chat/widget/createGroupWidget/setImageAppBAr.dart';
...
class _SetImageScreenState extends State<SetImageScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _key,
      appBar: PreferredSize(child: SetImageAppBar.customAppBar(_sizeH, 'new Group', _key, context, subtitle: 'add Subject'), preferredSize: Size.fromHeight(_sizeH / 10)),
